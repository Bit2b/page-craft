    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ?
        ...
        <button
          ...
          className="h-7 w-10 text-sm text-center border border-neutral-400  bg-transparent rounded-sm  cursor-text hover:bg-neutral-200/80">
          {currentFontSize}
        </button>
      }
...
const ListButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-8 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
...
const HeadingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 min-w-8 shrink-0 flex items-center justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[#f1f4f9] w-full px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto">
      {section[0].map((item) => (
